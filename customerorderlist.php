                                        ...
                                        <tbody>
                                            ...
                                            for ($i=0; $i < $count ; $i++) { 
                                                ...
                                                if ($deliverystatus=="Pending") {
                                                    echo "<td><a href='deliveryassign.php?orderid=$orderid' class='btn btn-outline-success'>Assign Delivery</a></td>";
                                                }
                                                else{
                                                    echo "<td><a href='deliveryassign.php?orderid=$orderid' class='btn btn-outline-success disabled'>Assign Delivery</a></td>";
                                                }
