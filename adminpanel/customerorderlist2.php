...
<body>
    <div class="page-wrapper" style="background-color: white;">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form action="customerorderlist2.php" method="post">
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            for ($i=0; $i < $count ; $i++) { 
                                                ...
                                                echo "<td>".$cancel."</td>";
                                                echo "<td><a href='customerorderdetail.php?orderid=$orderid' class='btn btn-outline-info'><i class='mdi mdi-information-variant'></i></a></td>";
