...
if (isset($_POST['btnlogin'])) {
    ...
    $query="SELECT s.*,st.stafftype as stafftype FROM staff s,stafftype st WHERE s.stafftypeid=st.stafftypeid AND s.email='$txtemail' AND s.password='$txtpassword'";
    ...
    if ($count<1) {
        ...
        echo "<script>window.alert('Login Successful as ".$stafftype."')</script>";
            ...
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    <div class="text-center p-t-20 p-b-20">
                        <h1 style="color: white;">Morning Restaurant</h1>
                        <h4 style="color: blue;">Admin Panel Login</h4>
                    </div>
                    <!-- Form -->
                        ...
                        <div class="row border-top border-secondary">
                            <div class="col-6">
                                <div class="form-group">
                                    <div class="p-t-20">
                                        <a href="../index.php"class="btn btn-danger" name="btncancel">Cancel</a>
                                    </div>
                                </div>
                            </div>                            
                            <div class="col-6">
