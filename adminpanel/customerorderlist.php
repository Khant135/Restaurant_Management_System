...
if (isset($_POST['btnsearch'])) {
    ...
    if ($rdosearch==1) {
        ...
        $query="SELECT * FROM customerorder WHERE paymentstatus='$cbopstatus'";
        $result=mysqli_query($connection,$query);
        // echo "<script>window.alert('$cbopstatus')</script>";
    }
    else if ($rdosearch==2) {
        $cbodstatus=$_POST['cbodstatus'];
        $query="SELECT * FROM customerorder WHERE deliverystatus='$cbodstatus'";
        $result=mysqli_query($connection,$query);
...
<body>
    <div class="page-wrapper" style="background-color: white;">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form action="customerorderlist.php" method="post">
                                        ...
                                        <tbody>
                                            ...
                                            for ($i=0; $i < $count ; $i++) { 
                                                ...
                                                if ($deliverystatus=="Pending" && $cancel=='No') {
                                                    echo "<td><a href='customerorderdetail.php?orderid=$orderid' class='btn btn-outline-info'><i class='mdi mdi-information-variant'></i></a>  <a href='deliveryassign.php?orderid=$orderid' class='btn btn-outline-success'>Assign Delivery</a></td>";
                                                }
                                                else{
                                                    echo "<td><a href='customerorderdetail.php?orderid=$orderid' class='btn btn-outline-info'><i class='mdi mdi-information-variant'></i></a>  <a href='deliveryassign.php?orderid=$orderid' class='btn btn-outline-success disabled'>Assign Delivery</a></td>";
                                                }
