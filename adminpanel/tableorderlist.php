...
<body>
    <div class="page-wrapper" style="background-color: white;">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form action="tableorderlist.php" method="post">
                                        ...
                                        <tbody>
                                            ...
                                            for ($i=0; $i < $count ; $i++) { 
                                                ...
                                                if ($paymentstatus=="Pending") {
                                                    echo "<td><a href='tableorderdetail.php?orderid=$orderid' class='btn btn-outline-info'><i class='mdi mdi-information-variant'></i></a>  <a href='tableorderpayment.php?orderid=$orderid' class='btn btn-outline-success'>Make Payment</a></td>";
                                                }
                                                else{
                                                    echo "<td><a href='tableorderdetail.php?orderid=$orderid' class='btn btn-outline-info'><i class='mdi mdi-information-variant'></i></a>  <a href='tableorderpayment.php?orderid=$orderid' class='btn btn-outline-success disabled'>Make Payment</a></td>";
                                                }
