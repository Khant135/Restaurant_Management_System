...
if (isset($_POST['btnsave'])) {
    ...
    $check="SELECT * FROM category WHERE category='$txtcategory'";
    ...
    if ($result) {
        ...
        echo "<p>Something went wrong in Category Entry: ".msqli_error($connection)."</p>";
    }
}
?>
<html>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="card border">
                        <form class="form-horizontal" action="category_entry.php" method="post">
                            <div class="card-body">
                                <div class="row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="category" name="txtcategory" placeholder="Category Name Here" required>
                                    </div>
                                </div>
                            </div>
                            <div>
