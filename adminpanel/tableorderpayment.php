...
if (isset($_POST['btnpayment'])) {
    ...
    $update="UPDATE tableorder SET paymentstatus='Confirmed' WHERE tableorderid='$orderid1'";
    $result=mysqli_query($connection,$update);

    if ($result) {
        echo "<script>window.alert('Pyament Process is Successful!!')</script>";
        echo "<script>window.location='tableorderlist.php'</script>";
    }
}

if (isset($_GET['orderid'])) {
    $orderid=$_GET['orderid'];
    $query="SELECT * FROM tableorder WHERE tableorderid='$orderid'";
    $result=mysqli_query($connection,$query);
    $arr=mysqli_fetch_array($result);

    $query1="SELECT td.*,m.menuname as menuname,m.price as price FROM tableorderdetail td,menu m WHERE td.menuid=m.menuid AND tableorderid='$orderid'";
...
<body>
    <div class="page-wrapper" style="background-color: white;">
                    ...
                    <div class="ml-auto text-right">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Table Order Payment</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="container-fluid">
            ...
            <!-- Start Page Content -->
            <!-- ============================================================== -->
            <form action="tableorderpayment.php" method="post">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12"><h5 class="card-title">Table Order Payment</h5></div>
                                </div>
                                <br>
                                <div class="table-responsive">
                                    <table class="table" style="table-layout: fixed;">
                                        ...
                                        <tr>
                                            <input type="hidden" name="txtorderid" value="<?php echo $arr['tableorderid']; ?>">
                                            <td colspan="2"><b>OrderID:</b> <?php echo $arr['tableorderid']; ?></td>
                                            <!-- <td colspan="2"></td> -->
                                            <td colspan="2" align="right"><b>TableID:</b> <?php echo $arr['tableid']; ?></td>
                                        </tr>
                                        <tr>
 ...
 <!--                                        <tr>
                                            <td colspan="2" align="right">PaymentType:</td>
                                            <td colspan="2">
                                                <input type="radio" name="rdopayment" onClick="COD()" checked> Cash Payment
                                                <input type="radio" name="rdopayment" onClick="Card()"> Card Payment
